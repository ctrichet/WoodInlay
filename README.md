...
![Logo du projet](images/SVG_layer.png)

JediCut is a preview tool for laser cutting projects, designed to give craftsmen, designers, and hobbyists a realistic visualization of their creations before cutting. It allows precise placement of pieces and simulates the final result by mapping the textures of the chosen materials directly onto the design.

While primarily tailored for **marquetry**, JediCut is versatile and can handle a wide range of laser cutting applications. The software also integrates an advanced **nesting engine**, optimizing the arrangement of parts on the material surface to minimize waste and save time.
...
JediCut is **currently under active development**. If you are interested in collaborating on the project, I warmly invite you to **get in touch** and join the effort.
...
Your contributions—whether through code, feedback, or sponsorship-are highly appreciated and help JediCut grow into a more powerful and versatile tool.
